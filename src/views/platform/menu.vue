        ...
        <el-dialog title="新增" width="750px" :visible.sync="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" label-width="80px" :rules="formRules" ref="addForm">
                <el-row>
                    ...
                    <el-col :span="12" v-if="addForm.type === 2 || addForm.type === 3">
        ...
        <el-dialog title="编辑" width="750px" :visible.sync="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="80px" :rules="formRules" ref="editForm">
                <el-row>
                    ...
                    <el-col :span="12" v-if="editForm.type === 2 || editForm.type === 3">
                        <el-form-item label="路径" prop="path">
...
export default {
    ...
    methods: {
        ...
        showAddDialog() {
            ...
            this.addForm.sort = this.menuData.length + 1
        },
        addSubmit() {
        ...
        handleParentChange(value) {
            const node = this.$refs.parentId.getCheckedNodes()[0]
            this.addForm.sort = node && node.children ? node.children.length + 1 : 1
        }
    }
}
</script>
